      ...
      <section className={styles.listPage}>
        {workingList && selectedList ? <>
          ...
          <div className={styles.listComposer}>
            <button type="button" onClick={addListRow}><PersonalOpsIcon name="plus" /> Add item</button>
