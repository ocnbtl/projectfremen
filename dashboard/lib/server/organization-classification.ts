...
export function classifyOrganizationServices(description: string, knownType = ""): { organizationType: string; industry: string } | null {
  ...
  const rules: [RegExp, string][] = [
    ...
    [/\b(?:(?:mobile|Swedish|deep tissue|relaxation|lymphatic|therapeutic) massage|massage (?:therapy|therapist|services|studio)|day spa|beauty treatments|reflexology|body scrubs?)\b/i, "Retail & consumer"],
